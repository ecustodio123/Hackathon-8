from helpers.helper import input_data, print_table, pregunta, input_isbn, input_fecha, cargo
...
class Roles_controller:
        ...
        while True:
            try:
                ...
                if not usuario_verificado:
                    ...
                    print("\nHa introducido mal la contraseña. Intentelo nuevamente")
                elif "lector" != usuario_verificado[3]:
                    print("\nUsted no tiene permiso de lector, debe utilizar administrador")
                elif contrasena == usuario_verificado[2]:
                    print(f'''
        ======================================
                Bienvenido {usuario_verificado[1]}
    ...
    def insertar_registro(self):
        ...
        if (contrasena != contrasena2):
            ...
            return
        cargo_final = cargo("¿Deseas darle cargo de administrador o lector")
        print(cargo_final)
